...
## Fiscal sustainability {.tabset-dropdown}
...
```{r}
#| fig.alt: >
#|   Plot of correlation between wage bill growth and fiscal balances.
...
```{r}
#| fig.alt: >
#|   Plot of decomposition of wage growth
...
## Wage incentives {.tabset-dropdown}
...
```{r}
#| fig.alt: >
#|   Plot of allowance as a share of gross pay.
...
```
<!-- ### Percentage of staff receiving a performance bonus -->

<!-- ```{r} -->
<!-- #| fig.alt: > -->
<!-- #|   Plot of staff receiving a performance bonus -->

<!-- performance_bonus_worker <- govhr::bra_hrmis_contract |> -->
<!--   filter( -->
<!--     !is.na(allowance_lcu) & -->
<!--       lubridate::year(ref_date) <= 2017 -->
<!--   ) |> -->
<!--   group_by(year) |> -->
<!--   summarise( -->
